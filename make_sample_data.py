...
SOVRASCRITTI dal primo "Scarica universo da BI" nell'app. I file dati veri sono
git-ignored; questi campioni sono committati nel repo a scopo dimostrativo.

Rigenerali con:  python make_sample_data.py
"""
...
SAMPLE = [
    ...
    _b("IT0000000008", "ESEMPIO BTP Tf 1,5% Nv27 (FAKE)", 1.5, "2027-11-01", "EUR",
       "gov_ita", "Titoli Di Stato Italiani", "Italia", False, 99.0, "MOT"),
]
